...
I work as a L4 R/shiny engineer at [Appsilon](https://www.appsilon.com/), a company that provides data science services to the biggest pharma companies in the world. I contributed to [open source packages](https://github.com/Appsilon/ConnectUserMetrics) and other internal tasks.
...
- [`shiny`](https://shiny.posit.co/): I explored a lot of the `shiny` ecosystem since 2018: from `shinydashboard` to the new [`bslib`](https://rstudio.github.io/bslib/), using [`shinyWidgets`](https://shinyapps.dreamrs.fr/shinyWidgets/) and [`toastui`](https://dreamrs.github.io/toastui/). I can create dashboards, CRUDS, user interfaces, display photos/videos and maps. Async and parallelism are a bit painful but can be done with `future` and `promises`.
...
- I can create packages, documentation and tests. Unfortunately, my best packages are private but a public example can be found [here](https://github.com/vituri/vituripackage).
...
- The [book](https://www.amazon.com/Hands-Design-Patterns-Julia-comprehensive/dp/183864881X) "Hands-On Design Patterns and Best Practices with Julia" is my bible, and I am rewriting all my previous code using what I learned there.
...
](https://www.tandfonline.com/doi/abs/10.1080/02626667.2024.2412741) (2024, published in [Hydrological Sciences Journal](https://www.tandfonline.com/journals/thsj20)), co-author.

-   Workshop: [Topological Data Analysis workshop](https://github.com/vituri/TDA_workshop_EBT2024) (2024, at the [XXIII Brazilian Topology Meeting](https://xxiiiebt.ime.ufba.br/)).
