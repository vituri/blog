...
Experienced data scientist and engineering leader with a strong background in **R, Julia, and mathematics**. Experienced in delivering quick, impactful data solutions and contributing to open-source and academic communities. Skilled with interactive dashboards in R/Shiny, data pipelines, machine learning models, and scientific research. Publishes on Topological Data Analysis (TDA) and geospatial analytics.
...
Argus provides solutions for fatigue and distraction detection, control towers, and telemetry in transport operations.

- Founded and led the Data team, growing it to over 12 members, including developers, data scientists, engineers, and mathematicians.
- Designed and implemented a MariaDB database on AWS, migrating from hundreds of Excel files.  
- Automated daily/weekly reporting with RMarkdown and Sendgrid, saving over 20 hours of manual work daily.
- Built analytics dashboards and platforms for photo and video analysis using R/Shiny.
- Developed a machine learning model to [predict driver drowsiness](https://www.linkedin.com/posts/luis-torin-00641245_tecnologia-inteligaeanciaartificial-logaedstica-activity-7012149778255900672-Daed), using ensemble methods with [`tidymodels`](https://www.tidymodels.org/).  
- Created a high-performance Julia webserver using [Oxygen.jl](https://oxygenframework.github.io/Oxygen.jl/stable/), reducing data ingestion time from four minutes (with R) to five seconds (with Julia).
- Led computer vision projects (cellphone detection, drowsiness, pothole, and gesture detection) using Keras and YOLO in Python.
- Managed hiring, mentoring, and professional development for the team.
...
- **SQL:** Advanced — MariaDB, database design, optimization, `dbplyr` in R
...
- **JuliaTDA Organization:** Owner and main contributor. Developed the [Mapper and Ball Mapper](https://juliatda.github.io/TDAmapper.jl/mapper.html) and [ToMATo](https://juliatda.github.io/ToMATo.jl/) algorithms in Julia.  
