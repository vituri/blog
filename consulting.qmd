...
::: {.contact-block}
> Contato: vituri.vituri@gmail.com / Github: [https://github.com/vituri](https://github.com/vituri){target="_blank"}
:::
...
Criação de gráficos, limpeza de dados, análise de dados de geoprocessamento, séries temporais e etc usando [R](https://www-r--project-org.translate.goog/?_x_tr_sl=en&_x_tr_tl=pt&_x_tr_hl=pt&_x_tr_pto=tc){target="_blank"}, [Python](https://www.python.org){target="_blank"} e [Julia](https://julialang.org){target="_blank"}.
